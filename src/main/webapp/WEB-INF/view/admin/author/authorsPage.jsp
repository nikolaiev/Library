            ...
            <tr id='${author.id}_row'>
                <form action="/admin/authors/update" method="post">
                    <td>
                        ...
                        <input class="form-control" id='${author.id}_name' name="author_name" value="${author.name}" type="text" pattern="${RegExConst.NAME_SONAME_REG_EX}">
                    </td>
                    <td>
                        <input class="form-control" id='${author.id}_soname' name="author_soname" value="${author.soname}" type="text" pattern="${RegExConst.NAME_SONAME_REG_EX}">
                    </td>
                    <td>
...
<div class="container top-buffer">
    ...
    <div class="row">
        ...
        <form method="post" action="/admin/authors/add" >
            <%--TODO localize--%>
            <div class="col-xs-6">
                <input type="text" class="form-control" name="publisher_title" placeholder="publisher title" pattern="${RegExConst.NAME_SONAME_REG_EX}"/>
                <input type="text" class="form-control" name="publisher_title" placeholder="publisher title" pattern="${RegExConst.NAME_SONAME_REG_EX}"/>
            </div>
