...
public class GetStaticFileCommand extends CommandWrapper implements Command {
    ...
    private final static Dispatcher DEFAULT_POST_NON_REDIRECT_DISPATCHER=
            new EmptyDispatcher();
    ...
    protected Dispatcher processExecute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        //TODO change with image in project directory!
        if(!file.exists())
        ...
        return DEFAULT_POST_NON_REDIRECT_DISPATCHER;
    }
}
